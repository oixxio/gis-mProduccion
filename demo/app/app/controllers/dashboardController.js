(function(){
	...
	function($location,dashboardFactory,$window,$scope,welcomeFactory){
		...
		dashboardFactory.getNombreProv(dashboardFactory.getProv()).success(function(response){
		...
		dashboardFactory.getDatosGenerales(dashboardFactory.getProv()).success(function(response){
		...
		$scope.datosProv = dashboardFactory.getDashData();
